...
public class HyperDriveCoreBehaviour : PhysicalEntity
{
    ...
    public void Respawn()
    {
        ...
        GameObject newCore = Instantiate(Resources.Load<GameObject>("Prefabs/Collectables/HyperDriveCore"));
        newCore.transform.position = spawnPosition;
    }
